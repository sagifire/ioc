...
Stage 16 і Stage 17 є human-directed extensions після історичного плану з `SPEC.md`.
Stage 17 працює з feature request для `0.0.2`, але audit не приймає всі пропозиції як
готовий implementation scope.
