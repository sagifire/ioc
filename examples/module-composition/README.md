...
- application composition binds a required port to an adapter over another module's public
  capability;
...
inspection, public capability resolution or capability-gating assertions fail, the example
throws an error.
